<?php
//=========التوكن=========//
$token = "7367434083:AAEEU3Ac2JMa9fGFQrnuOkraQ1KTlFalmI0"; 
...
#############
$admin = "6963513996";
$Dev = array("$admin","6963513996");
$eri = array("$admin","6963513996");
$idbot = "7367434083";
$sudo = "$admin";
$buy = "exwec";
$DevUser = "@$buy";
...
⋄︙ [تحديثات iiliiiqp الجديده](https://t.me/iiliiiqp)",
'parse_mode'=>"markdown",
...
[['text'=>"⋄ ترتيب الاوامر"]],
[['text'=>"⋄ تجربة iiliiiqp"],['text'=>"⋄ المطورين الثانويه"]],
...
[['text'=>"⋄ تعين iiliiiqp"],['text'=>"⋄ حذف iiliiiqp"]],
[['text'=>"⋄ رجوع"]],
],
'resize_keyboard'=>true
])
...
[['text'=>"✵⁞ مبرمج iiliiiqp ⁞✵",'url'=>"t.me/$buy"]],
]])
]); 
}
if($data == "nd3" ){
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة iiliiiqp ⋄",'url'=>"t.me/iiliiiqp"]],
]])
]); 
}
}
...
if ($text == "⋄ تعين iiliiiqp" or $text == "تغير امر iiliiiqp" and in_array($from_id,$Dev)){
file_put_contents("data/taen.json","sorceu");
bot("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"
⋄︙عزيزي ← [$first_name](tg://user?id=$from_id)
⋄︙قم بأرسال كليشة امر iiliiiqp
⋄︙[تعليمات الامر (مهم)](https://t.me/s_ilii)
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
...
"chat_id"=>$chat_id,
"text" => "
⋄︙تم تعين امر iiliiiqp
⋄︙بواسطة ← [$first_name](tg://user?id=$from_id)
 ",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
if ($text == "⋄ حذف iiliiiqp" or $text == "حذف امر iiliiiqp" and in_array($from_id,$Dev)){
bot("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"
⋄︙عزيزي ← [$first_name](tg://user?id=$from_id)
⋄︙تم حذف كليشة امر iiliiiqp
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);
...
⋄︙تعين امر iiliiiqp ← حذف امر iiliiiqp
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙قناة البوت ← @$chsource
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
'reply_to_message_id'=>$message_id,
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⋄︙الامر لـ ← ( المطور الاساسي - المطور الثانوي - مبرمج iiliiiqp )",
'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
]);
}}
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- CaRloS .",'url'=>"t.me/iiliiiqp"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
...
• لااستطيع طردك لانك منشئ •
 ...
 "chat_id"=>$chat_id,
 "text"=>"
• لااستطيع طردك لانك مبرمج iiliiiqp •
 ",
 'parse_mode'=>"HTML",
 'reply_to_message_id'=>$TTK,
 ]);
...
############
$sorceu = file_get_contents("data/sorceu.json");
if($text == "iiliiiqp" or $text == "سورس" or $text == "يا سورس" and $sorceu == null){
bot("sendmessage",['chat_id'=>$chat_id,'text'=>"
ᯓnizk
...
⌯- iiliiiqp يستخرج المعرف من الايدي
...
########
if($text == "⋄ تجربة iiliiiqp"){if(in_array($from_id,$Dev) or in_array($from_id,$eri)) {bot("sendmessage",['chat_id'=>$chat_id,'text'=>"✵⁞ *اليك قائمة تجربة iiliiiqp*\n━━━━━━━━━━━━━\n⌯⁞ [كروب تجربة iiliiiqp](https://t.me/THBBS)\n⌯⁞ [قناة شروحات iiliiiqp](https://t.me/TH3SS)\n━━━━━━━━━━━━━\n⌯⁞ [مطور iiliiiqp](https://t.me/exwec)",'parse_mode'=>"Markdown",'disable_web_page_preview'=> true ,'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"⌯⁞ كروب تجربة iiliiiqp ⁞⌯",'url'=>"t.me/thbbs"]],[['text'=>"⌯⁞ مطور iiliiiqp ⁞⌯",'url'=>"t.me/$buy"]],]])]);}}
#######
...
#---------#
if($text == "تحديث iiliiiqp" || $text == "⋄ تحديث iiliiiqp" || $text == "تحديث سورس" and in_array($from_id,$Dev)){
	$ver = phpversion();
 bot('sendMessage',[
 'chat_id'=>$chat_id,
